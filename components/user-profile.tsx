...
export function UserProfile({ onThemeChangeAction }: UserProfileProps) {
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      {/* Dropdown Menu for Customization */}
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56 border-purple-500/20 bg-black/90 backdrop-blur-xl">
          ...
          <DropdownMenuItem
            ...
            onClick={() => onThemeChangeAction("neon-city")}
          >
          ...
          <DropdownMenuItem
            className="focus:bg-purple-900/30 focus:text-purple-200"
            onClick={() => onThemeChangeAction("digital-dojo")}
          >
          ...
          <DropdownMenuItem
            className="focus:bg-purple-900/30 focus:text-purple-200"
            onClick={() => onThemeChangeAction("cyber-gym")}
          >
