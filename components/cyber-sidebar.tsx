...
interface CyberSidebarProps {
  onButtonClickAction: (sectionId?: string) => void;
}

export function CyberSidebar({ onButtonClickAction }: CyberSidebarProps) {
                    ...
                    <SidebarMenuItem key={item.label}>
                      ...
                      >
                        <SidebarMenuButton
                          ...
                          onClick={() => onButtonClickAction(item.sectionId)}
                          className={cn(
                            ...
                            item.active &&
                              "bg-gradient-to-r from-purple-900/40 to-pink-900/40 text-white after:w-full"
                          )}
                        >
                          <motion.div
                            animate={{
                              ...
                              rotate:
                                hoveredIndex === index ? [0, 10, -10, 0] : 0,
                            }}
